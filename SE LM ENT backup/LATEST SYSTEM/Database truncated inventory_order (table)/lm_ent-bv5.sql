...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2024 at 04:25 PM
...
(1, 1, 12.00, '2024-02-05', 'EJ ', 'LUNZURAN ', 'cash', 'active', '2024-02-20', 0.00, 0.00, 0.00),
(2, 1, 13.44, '2024-02-12', 'EJ ', 'NONE', 'cash', 'active', '2024-02-20', 0.00, 0.00, 13.44),
(3, 1, 12.84, '2024-02-13', 'EJ ', 'LUNZURAN', 'cash', 'active', '2024-02-20', 0.00, 0.00, 12.84),
(4, 1, 102.00, '2024-02-12', 'EJ ', 'SDGH', 'cash', 'active', '2024-02-20', 0.00, 0.00, 102.00),
(5, 1, 114.24, '2024-02-13', 'Customer 1', 'NONE', 'cash', 'active', '2024-02-20', 0.00, 0.00, 114.24);
...
(188, 136, 50, 5, 12.00, 0.00),
(189, 137, 50, 1, 12.00, 0.00),
(190, 137, 48, 1, 30.00, 0.00),
(191, 137, 49, 1, 60.00, 0.00),
(192, 138, 50, 1, 12.00, 0.00),
(193, 139, 50, 1, 12.00, 0.00),
(194, 140, 50, 1, 12.00, 0.00),
(195, 140, 48, 1, 30.00, 0.00),
(196, 140, 49, 1, 60.00, 0.00),
(197, 1, 50, 1, 12.00, 0.00),
(198, 2, 50, 1, 12.00, 0.00),
(199, 3, 50, 1, 12.00, 0.00),
(200, 4, 50, 1, 12.00, 0.00),
(201, 4, 48, 1, 30.00, 0.00),
(202, 4, 49, 1, 60.00, 0.00),
(203, 5, 50, 1, 12.00, 0.00),
(204, 5, 48, 1, 30.00, 0.00),
(205, 5, 49, 1, 60.00, 0.00);
...
--
ALTER TABLE `inventory_order`
  MODIFY `inventory_order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `inventory_order_product`
--
ALTER TABLE `inventory_order_product`
  MODIFY `inventory_order_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=206;
