...
function get_user_wise_total_order($connect)
{
	...
	foreach($result as $row)
	{
		...
		<tr>
			<td>'.$row['user_name'].'</td>
			<td align="right">P '.$row["order_total"].'</td>
			<td align="right">P '.$row["cash_order_total"].'</td>
			<td align="right">P '.$row["credit_order_total"].'</td>
		</tr>
		';
	...
	<tr>
		...
		<td align="right"><b>P '.$total_order.'</b></td>
		<td align="right"><b>P '.$total_cash_order.'</b></td>
		<td align="right"><b>P '.$total_credit_order.'</b></td>
	</tr></table></div>
	';
	return $output;
}
